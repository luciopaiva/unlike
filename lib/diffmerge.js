...
function diff(merge) {
    ...
    Object.keys(merge).forEach(function (filename) {
        ...
        if (file.left && file.right) {
            ...
            differsInCreationDate = file.right.ctime !== file.left.ctime;
            differsInModifiedDate = file.right.mtime !== file.left.mtime;
            differsInAccessDate = file.right.atime !== file.left.atime;
        } else if (file.left) {
            exists = 'left';
        } else {
            exists = 'right';
        ...
        file.diff = {
            ...
            differsInCreationDate: differsInCreationDate,
